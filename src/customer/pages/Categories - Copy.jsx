  ...
  useEffect(() => {
      setTimeout(() => {
        ...
        try {
          ...
          // Grid / List Toggle
          $('.shop-toolbar-btn button').on('click', function () {
            ...
            if (role === 'grid-list') {
              $('.archive-products').removeClass('grid-3').addClass('list-view')
              $('.archive-products .col-xl-3').removeClass('col-xl-3').addClass('col-xl-12 list-item-temp')
            } else {
              $('.archive-products').removeClass('list-view').addClass('grid-3')
              $('.archive-products .col-xl-12.list-item-temp').removeClass('col-xl-12 list-item-temp').addClass('col-xl-3')
            }
          })
